...
const Card = () => {
  return (
    <div className="relative z-50">
      ...
      {/* note2 */}
      <div className="absolute xl:top-24 xl:block md:hidden xl:right-64 lg:right-40 rotate-6">
      ...
      {/* note3 */}
      <div className="absolute xl:top-[600px] lg:top-[580px] md:top-[540px] right-48 md:right-16 -rotate-12">
      ...
      {/* note4 */}
      <div className="absolute top-12 left-[660px]">
      ...
      {/* note5 */}
      <div className="absolute top-28 left-72 rotate-12">
      ...
      {/* all notes */}
      <div className="absolute xl:top-[660px] md:top-[540px] left-[440px] rotate-6">
